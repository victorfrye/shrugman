resource "azurerm_static_web_app" "stapp" {
  ...
  resource_group_name = data.azurerm_resource_group.shrugman.name
  location            = data.azurerm_resource_group.shrugman.location
  tags                = data.azurerm_resource_group.shrugman.tags
